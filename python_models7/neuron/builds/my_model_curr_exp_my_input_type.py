...
from python_models7.neuron.input_types.my_input_type \
    import MyInputType
...
class MyModelCurrExpMyInputType(AbstractPopulationVertex):
    ...
    def __init__(
        ...
        input_type = MyInputType(n_neurons, my_multiplicator,
                                 my_input_parameter)
    ...
    def get_max_atoms_per_core():
        ...
        return MyModelCurrExpMyInputType._model_based_max_atoms_per_core

    @staticmethod
    def set_max_atoms_per_core(new_value):

        MyModelCurrExpMyInputType._model_based_max_atoms_per_core = \
            new_value
